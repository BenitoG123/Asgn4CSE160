...
class Vector3 {
    ...
    add(other) {
        ...
        //console.log("inside add", this.elements);
    ...
    static cross(other1, other2) {
        ...
        let a = other1.elements[1]*other2.elements[2] - other1.elements[2]*other2.elements[1];
        let b = other1.elements[2]*other2.elements[0] - other1.elements[0]*other2.elements[2];
        let c = other1.elements[0]*other2.elements[1] - other1.elements[1]*other2.elements[0];
        v3.elements[0] = a;
        v3.elements[1] = b;
        v3.elements[2] = c;
        // Don't delete the return statement.
    ...
    normalize() {
        ...
        //console.log("inside nomalize", this.elements);
